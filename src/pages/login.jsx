    ...
    <div className="flex justify-center items-center min-h-screen bg-[url('/images/bg.png')] bg-no-repeat bg-center bg-cover p-4">
      ...
      >
        ...
        <input
          type="email"
          placeholder="Email"
          className="border border-white  p-2 rounded  bg-transparent text-white"
          value={email}
        ...
        <button
          type="submit"
          disabled={loading}
          className="border border-white text-white bg-gradient-to-r from-slate-600 via-sky-700 to-indigo-800 p-4 z-50 py-2 rounded hover:bg-blue-700"
        >
